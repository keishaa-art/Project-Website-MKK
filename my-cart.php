...
if (isset($_GET["aksi"])) {
    if ($_GET["aksi"] == "hapus") {
        ...
        $query = mysqli_query($koneksi1, "INSERT INTO tb_transaksi(tanggal,id_pelanggan,total) VALUE ('" . date("Y-m-d") . "','$id_user','$total')");
        $id_transaksi = mysqli_insert_id($koneksi1);
...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <title>Kei's Online Shop My Cart</title>
...
<div class="text-center">
      ...
      <div class="table-responsive small">
        ...
        <tr>
             <td>
                <img src="<?= $value["foto"] ?>" height="100px"><?= $value["nama"] ?>
             </td>
             <td><?= $value["jumlah"] ?></td>
             <td>Rp <?php echo number_format($value["harga"]) ?></td>
             <td>Rp <?php echo number_format($value["jumlah"] * $value["harga"], 2); ?> </td>
             <td><a href="my-cart.php?aksi=hapus&id=<?= $value["id"]; ?>"><span class="btn btn-danger">Hapus</span></td>
   ...
   $total = $total + ($value["jumlah"] * $value["harga"]);
            ...
            <tr>
              ...
              <td>
                <a href="my-cart.php?aksi=beli"><span class="btn btn-outline-dark">Beli</span></a>
          </td>
          </tr>
          <?php
          }
